...
RUTA_DATOS_OUT <- "C:/Users/pc/Downloads/Taller Manejo De Datos/Data/Datos Output"

dir.create(RUTA_GRAFICOS, showWarnings = FALSE)
dir.create(RUTA_DATOS_OUT, showWarnings = FALSE)
...
write.csv(base_larga, file.path(RUTA_DATOS_OUT, "base_larga.csv"), row.names = FALSE)
...
write.csv(base_extensa, file.path(RUTA_DATOS_OUT, "base_extensa.csv"), row.names = FALSE)
